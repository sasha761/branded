        ...
        <div class="u-container">
          ...
          <div class="p-shop__flex">
            <div class="p-shop__sidebar">
              <aside class="l-sidebar js-accordion">
                <div class="l-sidebar__block js-accordion__item">
                  <h4 class="l-sidebar__title js-accordion__heading">
                    <span>Мужчинам</span>
                  ...
                  <ul
                    class="l-sidebar__list js-accordion__list"
                    style="box-sizing: border-box; display: none"
                  >
                    <li>
                      <a href="https://branded.com.ua/product-category/mans/nizhnee-bele-2/"
                        >Нижнее белье</a
                      >
                    </li>
                    <li>
                      <a href="https://branded.com.ua/product-category/mans/verhnyaya-odezhda-mans/"
                        >Верхняя одежда</a
                      >
                    </li>
                    <li>
                      <a href="https://branded.com.ua/product-category/mans/dzhinsy-mans/"
                        >Джинсы</a
                      >
                    </li>
                    <li>
                      <a
                        href="https://branded.com.ua/product-category/mans/povsednevnye-kostyumy-i-komplekty/"
                        >Повседневные костюмы и комплекты</a
                      >
                    </li>
                    <li>
                      <a href="https://branded.com.ua/product-category/mans/rubashki/">Рубашки</a>
                    </li>
                    <li>
                      <a href="https://branded.com.ua/product-category/mans/svitshoty-i-hudi/"
                        >Свитшоты и худи</a
                      >
                    </li>
                    <li>
                      <a href="https://branded.com.ua/product-category/mans/sport-mans/"
                        >Спортивные костюмы</a
                      >
                    </li>
                    <li>
                      <a href="https://branded.com.ua/product-category/mans/shorty-mans/">Шорты</a>
                    </li>
                    <li>
                      <a href="https://branded.com.ua/product-category/mans/shtany/">Штаны</a>
                    </li>
                    <li>
                      <a href="https://branded.com.ua/product-category/mans/futbolki-mans/"
                        >Футболки и поло</a
                      >
                    </li>
                  </ul>
                </div>
                <div class="l-sidebar__block js-accordion__item is-active">
                  <h4 class="l-sidebar__title js-accordion__heading">
                    <span>Женщинам</span>
                    <svg width="11px" height="7px" class="u-arrow">
                      <use xlink:href="#arrow"></use>
                  ...
                  >
                    <li>
                      <a
                        href="https://branded.com.ua/product-category/women/dzhempery-svitery-i-kardigany/"
                        >Джемперы, свитеры и кардиганы</a
                      >
                    </li>
                    <li>
                      <a
                        href="https://branded.com.ua/product-category/women/komplekty-i-povsednevnye-kostyumy/"
                        >Комплекты и повседневные костюмы</a
                      >
                    </li>
                    <li>
                      <a href="https://branded.com.ua/product-category/women/kupalniki/"
                        >Купальники</a
                      >
                    </li>
                    <li>
                      <a href="https://branded.com.ua/product-category/women/nizhnee-bele/"
                        >Нижнее белье</a
                      >
                    </li>
                    <li>
                      <a href="https://branded.com.ua/product-category/women/pidzhaki-i-kostyumy/"
                        >Пиджаки и костюмы</a
                      >
                    </li>
                    <li>
                      <a href="https://branded.com.ua/product-category/women/pizhama/">Пижамы</a>
                    </li>
                    <li>
                      <a href="https://branded.com.ua/product-category/women/tuniki-i-kombinezony/"
                        >Туники и комбинезоны</a
                      >
                    </li>
                    <li>
                      <a href="https://branded.com.ua/product-category/women/shorty/">Шорты</a>
                    </li>
                    <li><a href="https://branded.com.ua/product-category/women/yubki/">Юбки</a></li>
                    <li>
                      <a href="https://branded.com.ua/product-category/women/noski/">Носки</a>
                    </li>
                    <li>
                      <a href="https://branded.com.ua/product-category/women/bluzki-i-rubashki/"
                        >Блузки и рубашки</a
                      >
                    </li>
                    <li>
                      <a href="https://branded.com.ua/product-category/women/futbolki/"
                        >Футболки и поло</a
                      >
                    </li>
                    <li>
                      <a href="https://branded.com.ua/product-category/women/topy-i-bodi/"
                        >Топы и боди</a
                      >
                    </li>
                    <li>
                      <a href="https://branded.com.ua/product-category/women/dzhinsy-i-bruki/"
                        >Джинсы и брюки</a
                      >
                    </li>
                    <li>
                      <a href="https://branded.com.ua/product-category/women/dress/">Платья</a>
                    </li>
                    <li>
                      <a href="https://branded.com.ua/product-category/women/sport/"
                        >Спортивные костюмы</a
                      >
                    </li>
                    <li>
                      <a href="https://branded.com.ua/product-category/women/verhnyaya-odezhda/"
                        >Верхняя одежда</a
                      >
                    </li>
                    <li>
                      <a href="https://branded.com.ua/product-category/women/tolstovki-i-svitshoty/"
                        >Худи и свитшоты</a
                      >
                    </li>
                  </ul>
                ...
                <div class="l-sidebar__block">
                  <h4 class="l-sidebar__title"><span>Фильтры</span></h4>
                  <div class="l-filter">
                    <div
                      ...
                      >
                        ...
                        <div class="nice-select">
                          ...
                          <ul class="list">
                            ...
                            <li class="option" data-value="svetlo-korichnevyj">
                              Светло-коричневый
                            </li>
                ...
                <div class="l-shop__result">
                  ...
                  <div class="c-sort js-filter-sort">
                    <form class="woocommerce-ordering" method="get">
                      ...
                      <div class="nice-select">
                        <span class="current">По новизне</span>
                        <ul class="list">
                          <li class="option" data-value="popularity">По популярности</li>
                          <li class="option" data-value="rating">По рейтингу</li>
                          <li class="option selected" data-value="date">По новизне</li>
                          <li class="option" data-value="price">Цены: по возрастанию</li>
                          <li class="option" data-value="price-desc">Цены: по убыванию</li>
                        </ul>
                      </div>
                    ...
                    <div 
                      ...
                      >
                        ...
                        <div class="c-product__text">
                          ...
                          <p class="c-price">
                            {{ product.post_price }} грн
                          </p>
                          <!-- <p class="c-price">
                            <span class="woocommerce-Price-amount amount"
                              ><bdi
                                >1,999.00&nbsp;<span class="woocommerce-Price-currencySymbol"
                                  >грн</span
                                ></bdi
                              ></span
                            >
...
export default {
  ...
  methods: {
    getProducts() {
      fetch('https://branded.loc/wp-json/api/archive/get_products')
        .then((r) => r.json())
        .then((rowData) => this.products = rowData);

        //console.log(this.products); // Proxy(Array) {}
    }
  },

  watch: {
    products() {
      console.log('asd', this.products); //Proxy(Array){0: {…}, 1: {…}, 2: {…}, 3: {…}, 4: {…}, 5: {…}, 6: {…
    }
  }
}
</script>
