...
class My_WC_Widget_Recently_Viewed extends WC_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$context['viewed'] = Timber::get_posts($query_args);

		// $context['viewed'] = new WP_Query( apply_filters( 'woocommerce_recently_viewed_products_widget_query_args', $query_args ) );

		// if ( $context['viewed']->have_posts() ) {
...
$template = ['templates/woo/recently-viewed.twig'];
