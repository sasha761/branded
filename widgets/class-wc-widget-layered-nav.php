 ...
 */
class My_WC_Widget_Layered_Nav extends WC_Widget
{
	...
	public function __construct()
	{
		...
		$this->widget_name = __('My Filter Products by Attribute', 'woocommerce');
		parent::__construct();
	}
	...
	protected function layered_nav_dropdown($terms, $taxonomy, $query_type)
	{
		...
		if ($taxonomy !== $this->get_current_taxonomy()) {
			...
			echo '<form method="get" action="' . esc_url($form_action) . '" class="js-filter-form c-dropdown woocommerce-widget-layered-nav-dropdown">';
			echo '<select class="js-filter-select woocommerce-widget-layered-nav-dropdown dropdown_layered_nav_' . esc_attr($taxonomy_filter_name) . '" ' . ($multiple ? ' multiple="multiple"' : '') . '>';
			echo '<option value="" selected>' . esc_html($any_label) . '</option>';
