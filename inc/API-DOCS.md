...
// json
{
  "event": "incident.created", // "incident.resolved" // "incident.scheduled"
  "timestamp": "2026-03-23", // date now
  "incidents": [
    {
      "service_slug": "checkout_processing",
      "service_name": "Checkout Processing",
      "date": "2026-03-13", // can be past
      "time": "14:05"
      "status": "...",
      "message": "..."
    },
      ...
      "methods": {
        {
          "method_name": "Visa",
          "method_slug": "visa",
          "status": "operational", // "degraded_perfomance" // "scheduled_maintenance" ...
        },
        {
          "method_name": "Mastercard",
          "method_slug": "mastercard",
          "status": "degraded_perfomance",
        },
      }
      "date": "2026-03-13", // incedent date may be different
      "time": "14:05",
      "status": "error", // warning // maintenance
      "message": "...."
    },
    {
      "country_code": "AT",
      ...
      "date": "2026-03-13",
      "time": "14:15",
      "scheduled_end": "2026-03-27T07:00:00Z", // для плановых евентов
      "status": "maintenance",
      "message": "....."
    },
  ]
